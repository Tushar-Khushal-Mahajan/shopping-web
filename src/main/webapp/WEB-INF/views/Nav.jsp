	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link" href="About"><i
					class="fa fa-hand-o-right" aria-hidden="true"></i>About</a></li>
			...
			<li class="nav-item active"><a class="nav-link" href="My-section"><i
					class="fa fa-user-circle-o" aria-hidden="true"></i>Me</a></li>
		</ul>
